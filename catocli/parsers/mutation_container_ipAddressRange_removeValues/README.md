...
catocli mutation container ipAddressRange removeValues '{"accountId":"id","ipAddressRangeContainerRemoveValuesInput":{"ref":{"by":"ID","input":"string"},"values":{"from":"example_value","to":"example_value"}}}'
