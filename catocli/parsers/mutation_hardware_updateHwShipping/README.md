...
catocli mutation hardware updateHwShipping '{"accountId":"id","updateHwShippingInput":{"details":{"details":{"address":"id","comment":"string","incoterms":"string","instruction":"string"},"powerCable":"string"},"ids":["id1","id2"]}}'
