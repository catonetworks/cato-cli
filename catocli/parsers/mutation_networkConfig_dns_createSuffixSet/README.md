...
catocli mutation networkConfig dns createSuffixSet '{"accountId":"id","networkConfigDnsCreateSuffixSetInput":{"dnsSuffixSet":{"name":"string","suffix":["example1","example2"]}}}'
