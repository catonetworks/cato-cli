...
catocli mutation networkConfig dns updateServerSet '{"accountId":"id","networkConfigDnsUpdateServerSetInput":{"dnsServerSet":{"id":"id","name":"string","server":["example1","example2"]}}}'
