...
## CATO-CLI - mutation.object.createGlobalIpRangeBulk:
[Click here](https://api.catonetworks.com/documentation/#mutation-mutation.object.createGlobalIpRangeBulk) for documentation on this operation.

### Usage for mutation.object.createGlobalIpRangeBulk:

```bash
catocli mutation object createGlobalIpRangeBulk -h

catocli mutation object createGlobalIpRangeBulk <json>
