...
catocli mutation policy appTenantRestriction removeRule '{"accountId":"id","appTenantRestrictionPolicyMutationInput":{"revision":{"id":"id"}},"appTenantRestrictionRemoveRuleInput":{"id":"id"}}'
