...
catocli mutation policy clientConnectivity createPolicyRevision '{"accountId":"id","clientConnectivityPolicyMutationInput":{"revision":{"id":"id"}},"policyCreateRevisionInput":{"description":"string","name":"string"}}'
