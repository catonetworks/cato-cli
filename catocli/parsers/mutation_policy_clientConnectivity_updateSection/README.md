...
catocli mutation policy clientConnectivity updateSection '{"accountId":"id","clientConnectivityPolicyMutationInput":{"revision":{"id":"id"}},"policyUpdateSectionInput":{"id":"id","section":{"name":"string"}}}'
