...
catocli mutation policy privateAccess addSection '{"accountId":"id","policyAddSectionInput":{"at":{"position":"AFTER_SECTION","ref":"id"},"section":{"name":"string"}},"privateAccessPolicyMutationInput":{"revision":{"id":"id"}}}'
