...
catocli mutation policy privateAccess updatePolicy '{"accountId":"id","privateAccessPolicyMutationInput":{"revision":{"id":"id"}},"privateAccessPolicyUpdateInput":{"state":"ENABLED"}}'
