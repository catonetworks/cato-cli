...
catocli mutation policy remotePortFwd updatePolicy '{"accountId":"id","remotePortFwdPolicyMutationInput":{"revision":{"id":"id"}},"remotePortFwdPolicyUpdateInput":{"state":"ENABLED"}}'
