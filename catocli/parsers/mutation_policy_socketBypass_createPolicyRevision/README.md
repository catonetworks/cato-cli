...
catocli mutation policy socketBypass createPolicyRevision '{"accountId":"id","policyCreateRevisionInput":{"description":"string","name":"string"},"socketBypassPolicyMutationInput":{"revision":{"id":"id"}}}'
