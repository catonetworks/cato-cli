...
catocli mutation policy socketLan addSection '{"accountId":"id","policyAddSectionInput":{"at":{"position":"AFTER_SECTION","ref":"id"},"section":{"name":"string"}},"socketLanPolicyMutationInput":{"revision":{"id":"id"}}}'
