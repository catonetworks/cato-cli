...
catocli mutation policy socketLan firewall moveRule '{"accountId":"id","policyMoveSubRuleInput":{"id":"id","to":{"position":"AFTER_SUB_RULE","ref":"id"}},"socketLanPolicyMutationInput":{"revision":{"id":"id"}}}'
