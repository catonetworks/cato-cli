...
catocli mutation policy socketLan moveRule '{"accountId":"id","policyMoveRuleInput":{"id":"id","to":{"position":"AFTER_RULE","ref":"id"}},"socketLanPolicyMutationInput":{"revision":{"id":"id"}}}'
