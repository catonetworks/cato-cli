...
catocli mutation policy socketLan moveSection '{"policyMoveSectionInput":{"id":"id","to":{"position":"AFTER_SECTION","ref":"id"}},"socketLanPolicyMutationInput":{"revision":{"id":"id"}}}'
