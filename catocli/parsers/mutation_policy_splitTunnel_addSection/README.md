...
catocli mutation policy splitTunnel addSection '{"accountId":"id","policyAddSectionInput":{"at":{"position":"AFTER_SECTION","ref":"id"},"section":{"name":"string"}},"splitTunnelPolicyMutationInput":{"revision":{"id":"id"}}}'
