...
catocli mutation policy splitTunnel publishPolicyRevision '{"policyPublishRevisionInput":{"description":"string","name":"string"},"splitTunnelPolicyMutationInput":{"revision":{"id":"id"}}}'
