...
catocli mutation policy terminalServer moveSection '{"accountId":"id","policyMoveSectionInput":{"id":"id","to":{"position":"AFTER_SECTION","ref":"id"}},"terminalServerPolicyMutationInput":{"revision":{"id":"id"}}}'
