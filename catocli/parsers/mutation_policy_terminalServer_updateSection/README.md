...
catocli mutation policy terminalServer updateSection '{"accountId":"id","policyUpdateSectionInput":{"id":"id","section":{"name":"string"}},"terminalServerPolicyMutationInput":{"revision":{"id":"id"}}}'
