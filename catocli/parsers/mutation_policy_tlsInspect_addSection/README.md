...
catocli mutation policy tlsInspect addSection '{"accountId":"id","policyAddSectionInput":{"at":{"position":"AFTER_SECTION","ref":"id"},"section":{"name":"string"}},"tlsInspectPolicyMutationInput":{"revision":{"id":"id"}}}'
