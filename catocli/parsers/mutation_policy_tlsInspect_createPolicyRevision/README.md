...
catocli mutation policy tlsInspect createPolicyRevision '{"accountId":"id","policyCreateRevisionInput":{"description":"string","name":"string"},"tlsInspectPolicyMutationInput":{"revision":{"id":"id"}}}'
