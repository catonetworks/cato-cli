...
catocli mutation policy tlsInspect moveSection '{"accountId":"id","policyMoveSectionInput":{"id":"id","to":{"position":"AFTER_SECTION","ref":"id"}},"tlsInspectPolicyMutationInput":{"revision":{"id":"id"}}}'
