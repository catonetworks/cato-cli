...
catocli mutation policy tlsInspect moveSection '{"policyMoveSectionInput":{"id":"id","to":{"position":"AFTER_SECTION","ref":"id"}},"tlsInspectPolicyMutationInput":{"revision":{"id":"id"}}}'
