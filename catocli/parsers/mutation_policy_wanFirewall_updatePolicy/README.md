...
catocli mutation policy wanFirewall updatePolicy '{"accountId":"id","wanFirewallPolicyMutationInput":{"revision":{"id":"id"}},"wanFirewallPolicyUpdateInput":{"state":"ENABLED"}}'
