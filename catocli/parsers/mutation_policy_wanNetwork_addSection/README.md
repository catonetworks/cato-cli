...
catocli mutation policy wanNetwork addSection '{"accountId":"id","policyAddSectionInput":{"at":{"position":"AFTER_SECTION","ref":"id"},"section":{"name":"string"}},"wanNetworkPolicyMutationInput":{"revision":{"id":"id"}}}'
