...
catocli mutation policy wanNetwork moveSection '{"accountId":"id","policyMoveSectionInput":{"id":"id","to":{"position":"AFTER_SECTION","ref":"id"}},"wanNetworkPolicyMutationInput":{"revision":{"id":"id"}}}'
