...
catocli mutation policy wanNetwork publishPolicyRevision '{"accountId":"id","policyPublishRevisionInput":{"description":"string","name":"string"},"wanNetworkPolicyMutationInput":{"revision":{"id":"id"}}}'
