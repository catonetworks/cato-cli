...
catocli mutation policy ztnaAlwaysOn moveSection '{"accountId":"id","policyMoveSectionInput":{"id":"id","to":{"position":"AFTER_SECTION","ref":"id"}},"ztnaAlwaysOnPolicyMutationInput":{"revision":{"id":"id"}}}'
