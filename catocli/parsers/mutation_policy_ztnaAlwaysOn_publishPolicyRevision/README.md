...
catocli mutation policy ztnaAlwaysOn publishPolicyRevision '{"accountId":"id","policyPublishRevisionInput":{"description":"string","name":"string"},"ztnaAlwaysOnPolicyMutationInput":{"revision":{"id":"id"}}}'
