...
catocli mutation policy ztnaAlwaysOn updateSection '{"accountId":"id","policyUpdateSectionInput":{"id":"id","section":{"name":"string"}},"ztnaAlwaysOnPolicyMutationInput":{"revision":{"id":"id"}}}'
