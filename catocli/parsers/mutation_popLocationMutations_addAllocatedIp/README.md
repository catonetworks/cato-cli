...
catocli mutation popLocationMutations addAllocatedIp '{"accountId":"id","popLocationAddAllocatedIpInput":{"description":"string","popLocation":{"by":"ID","input":"string"},"type":"SYSTEM"}}'
