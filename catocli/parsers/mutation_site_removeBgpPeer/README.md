...
catocli mutation site removeBgpPeer --json-file mutation.site.removeBgpPeer.json

catocli mutation site removeBgpPeer '{"accountId":"id","removeBgpPeerInput":{"id":"id"}}'
