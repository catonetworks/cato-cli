...
catocli mutation site updateSecondaryGcpVSocket '{"accountId":"id","updateSecondaryGcpVSocketInput":{"gcpConfig":{"interfaceIp":"example_value","loadBalancerIp":"example_value"},"id":"id"}}'
