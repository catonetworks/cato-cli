...
catocli mutation site updateSiteSocketConfiguration '{"accountId":"id","updateSiteSocketConfigurationInput":{"primarySocketConfiguration":{"description":"string"},"secondarySocketConfiguration":{"description":"string"},"site":{"by":"ID","input":"string"}}}'
