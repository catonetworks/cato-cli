...
catocli mutation sites removeCloudInterconnectPhysicalConnection '{"accountId":"id","removeCloudInterconnectPhysicalConnectionInput":{"id":"id"}}'

catocli mutation sites removeCloudInterconnectPhysicalConnection '{
    "accountId": "id",
