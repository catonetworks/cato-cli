...
catocli mutation sites removeSecondaryAwsVSocket --json-file mutation.sites.removeSecondaryAwsVSocket.json

catocli mutation sites removeSecondaryAwsVSocket '{"accountId":"id","socketId":"id"}'
