...
catocli mutation sites updateSecondaryAwsVSocket '{"accountId":"id","updateSecondaryAwsVSocketInput":{"id":"id","ipAddress":"example_value","routeTableId":"string","subnet":"example_value"}}'
