...
catocli mutation ztnaAppConnector upgradeZtnaAppConnector '{"accountId":"id","upgradeZtnaAppConnectorInput":{"upgrades":{"targetVersion":"string","ztnaAppConnector":{"by":"ID","input":"string"}}}}'
