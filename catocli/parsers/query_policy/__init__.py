...
def query_policy_parse(query_subparsers):
    ...
    query_policy_siteWebProxy_parser = query_policy_subparsers.add_parser('siteWebProxy', 
            help='siteWebProxy() policy operation', 
            usage=get_help("query_policy_siteWebProxy"))

    def _show_query_policy_siteWebProxy_help(args, configuration=None):
        """Show help when query_policy_siteWebProxy is called without subcommand"""
        print("\ncatocli query policy siteWebProxy <subcommand> [options]")
        print("\nAvailable subcommands:")
        print("  policy                         policy operation")
        print("\nFor help on a specific subcommand:")
        print("  catocli query policy siteWebProxy <subcommand> -h")
        return None

    query_policy_siteWebProxy_subparsers = query_policy_siteWebProxy_parser.add_subparsers()
    query_policy_siteWebProxy_parser.set_defaults(func=_show_query_policy_siteWebProxy_help)

    query_policy_siteWebProxy_policy_parser = query_policy_siteWebProxy_subparsers.add_parser('policy', 
            help='policy() siteWebProxy operation', 
            usage=get_help("query_policy_siteWebProxy_policy"))

    query_policy_siteWebProxy_policy_parser.add_argument('json', nargs='?', default='{}', help='Variables in JSON format (defaults to empty object if not provided).')
    query_policy_siteWebProxy_policy_parser.add_argument('--json-file', help='Path to a file containing JSON input variables.')
    query_policy_siteWebProxy_policy_parser.add_argument('-accountID', help='The cato account ID to use for this operation. Overrides the account_id value in the profile setting.  This is use for reseller and MSP accounts to run queries against cato sub accounts from the parent account.')
    query_policy_siteWebProxy_policy_parser.add_argument('-t', const=True, default=False, nargs='?', help='Print GraphQL query without sending API call')
    query_policy_siteWebProxy_policy_parser.add_argument('-v', const=True, default=False, nargs='?', help='Verbose output')
    query_policy_siteWebProxy_policy_parser.add_argument('-p', const=True, default=False, nargs='?', help='Pretty print')
    query_policy_siteWebProxy_policy_parser.add_argument('-n', '--stream-events', dest='stream_events', help='Send events over network to host:port TCP')
    query_policy_siteWebProxy_policy_parser.add_argument('-z', '--sentinel', dest='sentinel', help='Send events to Sentinel customerid:sharedkey')
    query_policy_siteWebProxy_policy_parser.add_argument('-H', '--header', action='append', dest='headers', help='Add custom headers in "Key: Value" format. Can be used multiple times.')
    query_policy_siteWebProxy_policy_parser.add_argument('--headers-file', dest='headers_file', help='Load headers from a file. Each line should contain a header in "Key: Value" format.')
    query_policy_siteWebProxy_policy_parser.add_argument('--endpoint', dest='endpoint', help='Override the API endpoint from the profile. Requires --api-token and --accountID to be provided.')
    query_policy_siteWebProxy_policy_parser.add_argument('--api-token', dest='api_token', help='Override the API token from the profile. Requires --endpoint and --accountID to be provided.')
    query_policy_siteWebProxy_policy_parser.add_argument('--accountID', dest='accountID_override', help='Override the account ID from the profile. Can be used alone or with --endpoint and --api-token.')
    query_policy_siteWebProxy_policy_parser.add_argument('--trace-id', dest='trace_id', action='store_true', help='Enable tracing and print the trace ID from the response')
    query_policy_siteWebProxy_policy_parser.set_defaults(func=createRequest,operation_name='query.policy.siteWebProxy.policy')
    ...
    query_policy_socketBypass_parser = query_policy_subparsers.add_parser('socketBypass', 
            help='socketBypass() policy operation', 
            usage=get_help("query_policy_socketBypass"))

    def _show_query_policy_socketBypass_help(args, configuration=None):
        """Show help when query_policy_socketBypass is called without subcommand"""
        print("\ncatocli query policy socketBypass <subcommand> [options]")
        print("\nAvailable subcommands:")
        print("  policy                         policy operation")
        print("\nFor help on a specific subcommand:")
        print("  catocli query policy socketBypass <subcommand> -h")
        return None

    query_policy_socketBypass_subparsers = query_policy_socketBypass_parser.add_subparsers()
    query_policy_socketBypass_parser.set_defaults(func=_show_query_policy_socketBypass_help)

    query_policy_socketBypass_policy_parser = query_policy_socketBypass_subparsers.add_parser('policy', 
            help='policy() socketBypass operation', 
            usage=get_help("query_policy_socketBypass_policy"))

    query_policy_socketBypass_policy_parser.add_argument('json', nargs='?', default='{}', help='Variables in JSON format (defaults to empty object if not provided).')
    query_policy_socketBypass_policy_parser.add_argument('--json-file', help='Path to a file containing JSON input variables.')
    query_policy_socketBypass_policy_parser.add_argument('-accountID', help='The cato account ID to use for this operation. Overrides the account_id value in the profile setting.  This is use for reseller and MSP accounts to run queries against cato sub accounts from the parent account.')
    query_policy_socketBypass_policy_parser.add_argument('-t', const=True, default=False, nargs='?', help='Print GraphQL query without sending API call')
    query_policy_socketBypass_policy_parser.add_argument('-v', const=True, default=False, nargs='?', help='Verbose output')
    query_policy_socketBypass_policy_parser.add_argument('-p', const=True, default=False, nargs='?', help='Pretty print')
    query_policy_socketBypass_policy_parser.add_argument('-n', '--stream-events', dest='stream_events', help='Send events over network to host:port TCP')
    query_policy_socketBypass_policy_parser.add_argument('-z', '--sentinel', dest='sentinel', help='Send events to Sentinel customerid:sharedkey')
    query_policy_socketBypass_policy_parser.add_argument('-H', '--header', action='append', dest='headers', help='Add custom headers in "Key: Value" format. Can be used multiple times.')
    query_policy_socketBypass_policy_parser.add_argument('--headers-file', dest='headers_file', help='Load headers from a file. Each line should contain a header in "Key: Value" format.')
    query_policy_socketBypass_policy_parser.add_argument('--endpoint', dest='endpoint', help='Override the API endpoint from the profile. Requires --api-token and --accountID to be provided.')
    query_policy_socketBypass_policy_parser.add_argument('--api-token', dest='api_token', help='Override the API token from the profile. Requires --endpoint and --accountID to be provided.')
    query_policy_socketBypass_policy_parser.add_argument('--accountID', dest='accountID_override', help='Override the account ID from the profile. Can be used alone or with --endpoint and --api-token.')
    query_policy_socketBypass_policy_parser.add_argument('--trace-id', dest='trace_id', action='store_true', help='Enable tracing and print the trace ID from the response')
    query_policy_socketBypass_policy_parser.set_defaults(func=createRequest,operation_name='query.policy.socketBypass.policy')
    ...
    query_policy_socketLan_policyList_parser = query_policy_socketLan_subparsers.add_parser('policyList', 
            help='policyList() socketLan operation', 
            usage=get_help("query_policy_socketLan_policyList"))

    query_policy_socketLan_policyList_parser.add_argument('json', nargs='?', default='{}', help='Variables in JSON format (defaults to empty object if not provided).')
    query_policy_socketLan_policyList_parser.add_argument('--json-file', help='Path to a file containing JSON input variables.')
    query_policy_socketLan_policyList_parser.add_argument('-accountID', help='The cato account ID to use for this operation. Overrides the account_id value in the profile setting.  This is use for reseller and MSP accounts to run queries against cato sub accounts from the parent account.')
    query_policy_socketLan_policyList_parser.add_argument('-t', const=True, default=False, nargs='?', help='Print GraphQL query without sending API call')
    query_policy_socketLan_policyList_parser.add_argument('-v', const=True, default=False, nargs='?', help='Verbose output')
    query_policy_socketLan_policyList_parser.add_argument('-p', const=True, default=False, nargs='?', help='Pretty print')
    query_policy_socketLan_policyList_parser.add_argument('-n', '--stream-events', dest='stream_events', help='Send events over network to host:port TCP')
    query_policy_socketLan_policyList_parser.add_argument('-z', '--sentinel', dest='sentinel', help='Send events to Sentinel customerid:sharedkey')
    query_policy_socketLan_policyList_parser.add_argument('-H', '--header', action='append', dest='headers', help='Add custom headers in "Key: Value" format. Can be used multiple times.')
    query_policy_socketLan_policyList_parser.add_argument('--headers-file', dest='headers_file', help='Load headers from a file. Each line should contain a header in "Key: Value" format.')
    query_policy_socketLan_policyList_parser.add_argument('--endpoint', dest='endpoint', help='Override the API endpoint from the profile. Requires --api-token and --accountID to be provided.')
    query_policy_socketLan_policyList_parser.add_argument('--api-token', dest='api_token', help='Override the API token from the profile. Requires --endpoint and --accountID to be provided.')
    query_policy_socketLan_policyList_parser.add_argument('--accountID', dest='accountID_override', help='Override the account ID from the profile. Can be used alone or with --endpoint and --api-token.')
    query_policy_socketLan_policyList_parser.add_argument('--trace-id', dest='trace_id', action='store_true', help='Enable tracing and print the trace ID from the response')
    query_policy_socketLan_policyList_parser.set_defaults(func=createRequest,operation_name='query.policy.socketLan.policyList')
    ...
    query_policy_privateAccess_parser = query_policy_subparsers.add_parser('privateAccess', 
            help='privateAccess() policy operation', 
            usage=get_help("query_policy_privateAccess"))

    def _show_query_policy_privateAccess_help(args, configuration=None):
        """Show help when query_policy_privateAccess is called without subcommand"""
        print("\ncatocli query policy privateAccess <subcommand> [options]")
        print("\nAvailable subcommands:")
        print("  policy                         policy operation")
        print("\nFor help on a specific subcommand:")
        print("  catocli query policy privateAccess <subcommand> -h")
        return None

    query_policy_privateAccess_subparsers = query_policy_privateAccess_parser.add_subparsers()
    query_policy_privateAccess_parser.set_defaults(func=_show_query_policy_privateAccess_help)

    query_policy_privateAccess_policy_parser = query_policy_privateAccess_subparsers.add_parser('policy', 
            help='policy() privateAccess operation', 
            usage=get_help("query_policy_privateAccess_policy"))

    query_policy_privateAccess_policy_parser.add_argument('json', nargs='?', default='{}', help='Variables in JSON format (defaults to empty object if not provided).')
    query_policy_privateAccess_policy_parser.add_argument('--json-file', help='Path to a file containing JSON input variables.')
    query_policy_privateAccess_policy_parser.add_argument('-accountID', help='The cato account ID to use for this operation. Overrides the account_id value in the profile setting.  This is use for reseller and MSP accounts to run queries against cato sub accounts from the parent account.')
    query_policy_privateAccess_policy_parser.add_argument('-t', const=True, default=False, nargs='?', help='Print GraphQL query without sending API call')
    query_policy_privateAccess_policy_parser.add_argument('-v', const=True, default=False, nargs='?', help='Verbose output')
    query_policy_privateAccess_policy_parser.add_argument('-p', const=True, default=False, nargs='?', help='Pretty print')
    query_policy_privateAccess_policy_parser.add_argument('-n', '--stream-events', dest='stream_events', help='Send events over network to host:port TCP')
    query_policy_privateAccess_policy_parser.add_argument('-z', '--sentinel', dest='sentinel', help='Send events to Sentinel customerid:sharedkey')
    query_policy_privateAccess_policy_parser.add_argument('-H', '--header', action='append', dest='headers', help='Add custom headers in "Key: Value" format. Can be used multiple times.')
    query_policy_privateAccess_policy_parser.add_argument('--headers-file', dest='headers_file', help='Load headers from a file. Each line should contain a header in "Key: Value" format.')
    query_policy_privateAccess_policy_parser.add_argument('--endpoint', dest='endpoint', help='Override the API endpoint from the profile. Requires --api-token and --accountID to be provided.')
    query_policy_privateAccess_policy_parser.add_argument('--api-token', dest='api_token', help='Override the API token from the profile. Requires --endpoint and --accountID to be provided.')
    query_policy_privateAccess_policy_parser.add_argument('--accountID', dest='accountID_override', help='Override the account ID from the profile. Can be used alone or with --endpoint and --api-token.')
    query_policy_privateAccess_policy_parser.add_argument('--trace-id', dest='trace_id', action='store_true', help='Enable tracing and print the trace ID from the response')
    query_policy_privateAccess_policy_parser.set_defaults(func=createRequest,operation_name='query.policy.privateAccess.policy')
