...
catocli query policy socketLan policyList '{"socketLanPolicyListInput":{"pagingInput":{"from":1,"limit":1},"socketLanPolicyListFilterInput":{"id":{"eq":"id","in":["id1","id2"],"neq":"id","nin":["id1","id2"]},"name":{"eq":"string","in":["string1","string2"],"neq":"string","nin":["string1","string2"]},"policyLevel":{"eq":"MAIN","in":"MAIN","neq":"MAIN","nin":"MAIN"}},"socketLanPolicyListSortInput":{"name":{"direction":"ASC","priority":1},"policyLevel":{"direction":"ASC","priority":1}}}}'
...
catocli query policy socketLan policyList '{
    "socketLanPolicyListInput": {
        ...
        "socketLanPolicyListFilterInput": {
            "id": {
                "eq": "id",
                "in": [
                    "id1",
